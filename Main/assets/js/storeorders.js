...
function deleteOrder(userEmail, userOrders, orderKey, orderDetails) {
    ...
    const userOrderRef = firebase.database().ref('Store_Users_Order');
    userOrderRef
        .child(userEmail)
        .child(orderKey)
        .remove()
...
// firebase.database()
//     .ref('Store_Users_Order/sebin_Orders')
//     .on('value', function (snapshot) {
//         if (snapshot.exists()) {
...
// Import the newStore array from main.js
//import { newStore } from './main.js';
